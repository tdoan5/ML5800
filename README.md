...
The 2<sup>nd</sup> and 3<sup>rd</sup> connection methods are way simple, but you may experience severe delay or lag. The connection performances are not as 'smooth' as the 1<sup>st</sup> method's. 
